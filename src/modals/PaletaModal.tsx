...
import AvisoModal, { useAvisoModal } from "./AvisoModal";
    ...
    const handleSave = (e: React.MouseEvent) => {
        ...
        if (!nomePaleta.trim()) {
            mostrarModal({
                ...
                mensagem: 'Por favor, preencha o nome da paleta.',
                mostrarFechar: true,
        ...
        const coresVazias = cores.some(c => !c.nome_cor.trim() || !c.cod_cor.trim());
        if (coresVazias) {
            mostrarModal({
                tipo: 'erro',
                titulo: 'Campos Obrigatórios',
                mensagem: 'Por favor, preencha o nome e selecione a cor para todas as cores da paleta.',
                mostrarFechar: true,
                mostrarConfirmar: false
            });
            return;
